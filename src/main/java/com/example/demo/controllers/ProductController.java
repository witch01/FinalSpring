...
@PostMapping("/add")
public String ProductPostAdd (@ModelAttribute("product") @Valid Product product, BindingResult bindingResult, @RequestParam String names,
                              Model model)
    {
...
//        List<Post> result = postRepository.findLikeTitle(title);
    ...
    @PostMapping("/{id}/edit")
    public String productUpdate(@ModelAttribute("product")@Valid Product product, BindingResult bindingResult, @RequestParam String names,
